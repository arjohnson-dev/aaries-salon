...
const serviceSections = [
  ...
  },
  {
    ...
    image: colorImage,
    rows: [
      { name: "Full Bleach", price: "$130" },
      { name: "Bleach Touch-Up", price: "$90" },
      { name: "Highlights", price: "$100" },
      { name: "Highlights — Top Only", price: "$80" },
      { name: "Full Color", price: "$95" },
      { name: "Full Color (pre-lightened)", price: "$60" },
      { name: "Additional Colors", price: "$20" },
